					...
					<div class="featured">
						<div class="tabbed_container">
							...
							<?php
								// database connection 
								include("dbconn.php");
								$sql="SELECT * FROM product where pt_id=1";
								...
								?>
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<?php echo $row_rs['product_pic']; ?>"></div>
											<div class="product_content">
											<div class="product_price">RM<?php echo $row_rs['product_price']; ?></div>
											<div class="product_name"><?php echo $row_rs['product_name']; ?></div>
											<div class="product_extras">
												<form action="addtocart.php" method="post">
													<input type="hidden" name="product_id" value="<?php echo $row_rs['product_id'];?>">
													<input type="hidden" name="client_id" value="<?php echo $clientid;?>">
													<input type="submit" name="submit" value="Add to Cart" class="product_cart_button">
												</form>
												</div>
											</div>
										</div>
							...
							<div class="product_panel panel">
								...
								<?php
								$sql2="SELECT * FROM product where pt_id=2";
								...
								?>
									...
									<div class="featured_slider_item">
										<div class="border_active"></div>
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<?php echo $row_rs2['product_pic']; ?>"></div>
											<div class="product_content">
											<form action="cart.php" method="post">
												<div class="product_price">RM<?php echo $row_rs2['product_price']; ?></div>
												<div class="product_name"><?php echo $row_rs2['product_name']; ?></div>
												<div class="product_extras">
													<button class="product_cart_button" type="submit" value="submit" >Add to Cart</button> 
												</div>
											</form>
											</div>
										</div>
